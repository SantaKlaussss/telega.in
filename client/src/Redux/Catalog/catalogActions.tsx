import { CHANNELS_ERROR_ACTION, CURRENT_PAGE_ACTION, FETCH_CHANNELS_ACTION, GET_DATA_SUCCESS_ACTION, SortsOrder, SortsType, VALUE_SEARCH_ACTION, VALUE_SORT_ACTION, channelType, createAction, pageType } from '../Types';
